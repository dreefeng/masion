/*
 * $Id: DESCrypt.java,v 1.5 2005/09/02 19:02:10 k Exp $
...
/**
 * Contains static methods for encrypting passwords with the standard DES
 * algorithm.
 *
 * Based upon jcrypt.java written by John F. Dumas
 * (jdumas@locutus.kingwoodcable.com) which is based upon C source code written
...
public class DESCrypt extends Crypt {
	...
	/**
	 * Converts byte array of four bytes to one int.
	 *
	 * @param b
	 *            The byte array
	 * @param offset
	...
	/**
	 * Converts an int into a byte array containing four bytes.
	 *
	 * @param iValue
	 *            The integre value
	 * @param b
	...
	/**
	 * Encrypts the given password with given salt and returns the encrypted
	 * password hash.
	 *
	 * @param password
	 *            Cleartext password
	...
	public static void main(String[] args) {
		String en = DESCrypt.crypt("2013-04-11");
