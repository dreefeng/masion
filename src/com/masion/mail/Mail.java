...
import com.masion.security.Base64;
        ...
        try {
            ...
            if(!file.isEmpty()){//有附件
                ...
                while(efile.hasMoreElements()){
                    ...
                    String encodedName = Base64.encode(fname.getBytes());//使用Base64编码避免附件名称中文乱码
                    mbp.setFileName("=?GBK?B?" + encodedName + "?=");//得到文件名同样至入BodyPart
                    mp.addBodyPart(mbp);
                }
